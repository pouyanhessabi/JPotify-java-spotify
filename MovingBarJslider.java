...
public class MovingBarJslider extends JSlider {
    ...
    public MovingBarJslider(int min, int max, int value) {
        ...
        d = new UIDefaults();
        d.put("Slider:SliderTrack[Enabled].backgroundPainter", new Painter<MovingBarJslider>() {
            @Override
            public void paint(Graphics2D g, MovingBarJslider c, int w, int h) {
                int arc = 10;
                int trackHeight = 8;
                int trackWidth = w - 2;
                int fillTop = 4;
            ...
            protected int xPositionForValue(int value, MovingBarJslider slider, Rectangle trackRect) {
        ...
        z = new UIDefaults();
        z.put("Slider:SliderTrack[Enabled].backgroundPainter", new Painter<MovingBarJslider>() {
            @Override
            public void paint(Graphics2D g, MovingBarJslider c, int w, int h) {
                int arc = 10;
                int trackHeight = 8;
